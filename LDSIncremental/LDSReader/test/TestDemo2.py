...
class TestDemo2(unittest.TestCase):
    ...
    def test01Parcels(self):
        ...
        st = "python ../ldsreplicate.py -u "+self.UC+" -l v:x"+str(l)+" -e 2193 -c "+self.BB+" init "+self.DB
        print st
    ...
    def test02Roads(self):
        ...
        l = 793
        self.prepLayer(l, self.DB)
        st = "python ../ldsreplicate.py -u "+self.UC+" -l v:x"+str(l)+" -e 2193 -c "+self.BB+" "+self.DB
        print st
        self.assertEquals(os.system(st),0)
    ...
    def test05ASPTitleParcels(self):
        ...
        l = 1569
        self.prepLayer(l, self.DB)
        st = "python ../ldsreplicate.py -u "+self.UC+" -l v:x"+str(l)+" "+self.DB
        print st
        self.assertEquals(os.system(st),0)     
    ...
    def prepLayer(self,l,o):
        ...
        stc = 'python ../ldsreplicate.py -u '+self.UC+' -l v:x'+str(l)+' clean '+self.DB
        print stc
        os.system(stc)
